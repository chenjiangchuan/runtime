                              ...
                              size_t *outAllocatedSize = nil)
{
    ...
    // Read class's info bits all at once for performance:性能
    bool hasCxxCtor = cls->hasCxxCtor(); // false
    bool hasCxxDtor = cls->hasCxxDtor(); // false
    bool fast = cls->canAllocIndexed(); // true  indexed:索引
