...
// shortcutting optimizations. 适当的编译器优化
...
callAlloc(Class cls, bool checkNil, bool allocWithZone=false)
{
...
#if __OBJC2__
    if (! cls->ISA()->hasCustomAWZ()) { // custom allocWithZone:自定义allocWithZone方法 y
        // No alloc/allocWithZone implementation. Go straight(直接) to the allocator.
    ...
    // No shortcuts available. 没有可用的优化
